    ...
    <div class="login-container">
      ...
      <div class="right-section">
        <div class="login-card">
          <h3 class="animated delay-1">GANTI PASSWORD</h3>
          ...
          <button @click="changePassword" type="button" class="animated delay-5">
            <i class="fa-solid fa-right-to-bracket"></i> Simpan Password
          </button>
        </div>
      </div>
    </div>
...
const changePassword = async () => {
  ...
  try {
    ...
    await axios.post(
      'https://suburban-designated-authorized-conditional.trycloudflare.com/api/change-password',
      {
