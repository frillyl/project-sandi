...
const openModal = async (arsip) => {
  ...
  try {
    const resSummary = await axios.get(`https://summit-boating-mins-salon.trycloudflare.com/summarize/${arsip.id}`)
  ...
  try {
    const resRekomendasi = await axios.get(`https://summit-boating-mins-salon.trycloudflare.com/recommendation/${arsip.id}`)
