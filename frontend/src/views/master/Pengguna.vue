...
const API_URL = 'https://avi-initiative-basics-xml.trycloudflare.com/api/users'
const users = ref([])
...
const resetPassword = async (userId) => {
  try {
    await axios.post(
      `https://avi-initiative-basics-xml.trycloudflare.com/api/users/${userId}/reset-password`,
    )
    Swal.fire({
      icon: 'success',
      title: 'Berhasil',
