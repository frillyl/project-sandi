...
const API_URL = 'https://suburban-designated-authorized-conditional.trycloudflare.com/api/users'
const users = ref([])
...
const resetPassword = async (userId) => {
  try {
    await axios.post(
      `https://suburban-designated-authorized-conditional.trycloudflare.com/api/users/${userId}/reset-password`,
    )
    Swal.fire({
      icon: 'success',
      title: 'Berhasil',
