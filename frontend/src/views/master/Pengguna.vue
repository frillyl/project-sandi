...
const API_URL = 'https://sherman-newport-societies-treasures.trycloudflare.com/api/users'
const users = ref([])
...
const resetPassword = async (userId) => {
  try {
    await axios.post(
      `https://sherman-newport-societies-treasures.trycloudflare.com/api/users/${userId}/reset-password`,
    )
    Swal.fire({
      icon: 'success',
      title: 'Berhasil',
